...
Единственный способ дать плагину собственные стили и скрипты помимо этого
поля — инлайн прямо в разметке, а инлайн несовместим с `Content-Security-Policy`
хост-приложения и вырезается его HTML-санитайзером.
